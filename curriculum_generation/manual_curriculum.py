...
for level in range(0, 10):
  curriculum.append(
    TaskSpec(
      ...
      eval_fn_kwargs={"agent_type": "npc", 'level': level, "num_agent": 20 - level},
...
for num_agent in [1, 2]:
  for level in LEVEL_GOAL:
    for combat_style in COMBAT_STYLE:
      curriculum.append(
        TaskSpec(eval_fn=FullyArmed,
                 eval_fn_kwargs={"combat_style": combat_style, "level": level, "num_agent": num_agent},
